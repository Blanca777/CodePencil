...
const subtitle_fontAtOpen = document.getElementsByClassName(
  'subtitle_fontAtOpen'
)[0];
const subtitle_fontAtClose = document.getElementsByClassName(
...
const volume_content = document.getElementsByClassName('volume_content')[0];

volumeWrapper.addEventListener('click', function () {
  if (volume_state) {
    volume_content.classList = 'volume_content volume_close';
  } else {
    volume_content.classList = 'volume_content volume_open';
  }
